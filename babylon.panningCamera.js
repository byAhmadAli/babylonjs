var __extends = this.__extends || function (d, b) {
            ...
            (function (BABYLON) {
                ...
                var PanningCamera = (function (_super) {

                    __extends(PanningCamera, _super);

                    function PanningCamera(name, alpha, beta, radius, target, scene) {
                    ...
                    PanningCamera.prototype._getTargetPosition = function () {
                    ...
                    PanningCamera.prototype._initCache = function () {
                    ...
                    PanningCamera.prototype._updateCache = function (ignoreParentClass) {
                    ...
                    PanningCamera.prototype._isSynchronizedViewMatrix = function () {
                    ...
                    PanningCamera.prototype.attachControl = function (element, noPreventDefault) {
                        ...
                        if (this._onPointerDown === undefined) {
                            ...
                            this._onPointerDown = function (evt) {
                                ...
                                // Handle right click. Right click = panning
                            ...
                            this._onPointerUp = function (evt) {
                                ...
                                _this._lastPanningPosition = BABYLON.Vector2.Zero();
                                ...
                                switch (pointers.count) {
                                    ...
                                    case 1:

                                        {
                                            ...
                                            // Transform the camera's target using the cursor position

                                            if (_this._isRightClick) {
                                                ...
                                                var panValue = 0.005;
                                                var diffx = (evt.clientX - _this._lastPanningPosition.x) * panValue;

                                                var diffy = (evt.clientY - _this._lastPanningPosition.y) * panValue;
                                            ...
                                            // Else, rotate the camera around its target
                    ...
                    PanningCamera.prototype.detachControl = function (element) {
                    ...
                    PanningCamera.prototype._checkInputs = function () {
                    ...
                    PanningCamera.prototype._checkLimits = function () {
                    ...
                    PanningCamera.prototype.setPosition = function (position) {
                    ...
                    PanningCamera.prototype._getViewMatrix = function () {
                    ...
                    PanningCamera.prototype.zoomOn = function (meshes) {
                    ...
                    PanningCamera.prototype.focusOn = function (meshesOrMinMaxVectorAndDistance) {
                    ...
                    PanningCamera.prototype.createRigCamera = function (name, cameraIndex) {
                        ...
                        switch (this.cameraRigMode) {
                            ...
                            case BABYLON.Camera.RIG_MODE_VR:
                                ...
                                return new BABYLON.ArcRotateCamera(name, this.alpha + alphaShift, this.beta, this.radius, this.target, this.getScene());
                    ...
                    PanningCamera.prototype._updateRigCameras = function () {
                    ...
                    return PanningCamera;

                })(BABYLON.TargetCamera);

                BABYLON.PanningCamera = PanningCamera;
